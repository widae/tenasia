<?php 
    ...
    function get_read_investmentinsight()
    {
        ...
        $sql = "SELECT * FROM investmentinsight WHERE id = $notice_id";
		...
		<div class="row">
			<div class="container-full" style="width:100%; min-height:700px;">				
				<div style="width:1000px; margin:0 auto; padding-top:20px;">			
					<form id="modify_regist_form" name="modify_regist_form" method="post" action="./investmentinsight_proc_modify.php">
									...
									<div style="margin-left:100px;">
										...
										<div>
								    		<input type="text" name="title" id="title" placeholder="제목을 입력하세요."
								    			style="width:700px;" value="<?=$read_investmentinsight['title']?>">
										</div>
										...
										<div>
										    <textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:766px; height:250px;">
										    	<?=$read_investmentinsight['contents']?>										    	
										    </textarea>	
										</div>
									</div>
								</div>
