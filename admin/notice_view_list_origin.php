<?php
    ...
    {
        global $mysqli, $type;
        $sql = "SELECT * FROM notice WHERE type = '$type' AND is_deleted = 0";
    ...
    function get_read_marketview()
    {
        ...
        $sql = "SELECT * FROM notice WHERE type = '$type' ORDER BY id desc limit $curr, $cntPerPage";
        $rows = get_rows($mysqli, $sql);
                    ...
                    <div class="notice_table" style="margin-top:80px;">
                        ...
                        <div class="notice_row" style="height:50px;">
                            ...
                            <div class="notice_cell text-center">
                                ...
                                ?>
                                <a href="./regist_notice_file.php?id=<?=$items['id']?>" target="_blank">
                                    <?=$items['id']?>
                                </a>
                                <?php
                                } else if(strpos($type,"research") !== false) {
                                ?>
                                <a href="./regist_image.php?id=<?=$items['id']?>" target="_blank">
                                    <?=$items['id']?>
                                </a>
                                <?php
                                } else {
                            ...
                            <div class="notice_cell">
                                <a href="./notice_view_modify.php?type=<?=$type?>&id<?=$items['id']?>">
                                    <?=$list_title?>
                                </a>
                            </div>
